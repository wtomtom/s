...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "S.lnk";
}
...
{
    return GetAutostartDir() / "S.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("S-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  S-qt [" + tr("command-line options") + "]                     " + "\n";
