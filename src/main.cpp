...
#if defined(NDEBUG)
# error "S cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 10; // 8 hours
...
const string strMessageMagic = "S Signed Message:\n";
...
//////////////////////////////////////////////////////////////////////////////
//
// RegiSSSion of network node signals.
//
